//to create the actual form on the page
...
class Form extends React.Component {
    ...
    validateInput = async () => {
        ...
        if (this.state.longURL.length === 0) {
            ...
            errors.push("longURL");
            errorMessages['longURL'] = 'Please write a URL in the form of https://www....';
        }
        ...
        return (
            <div className="container">
                <form autoComplete="off">
                    ...
                    <div className="form-group">
                        <label htmlFor="basic-url">Dah Pendek</label>
                        <div className="input-group mb-3">
                            <div className="input-group-prepend">
                                <span className="input-group-text">pendekkan.com/</span>
                            </div>
                            <input
                                id="preferedAlias"
                                onChange={this.handleChange}
